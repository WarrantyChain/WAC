                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("WAC Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a WAC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and wac: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About WAC Core"), this);
    aboutAction->setStatusTip(tr("Show information about WAC Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for WAC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your WAC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified WAC addresses"));
    ...
    openAction->setStatusTip(tr("Open a WAC: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the WAC Core help message to get a list with possible WAC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("WAC Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to WAC network", "", count));
}
...
{
    QString strTitle = tr("WAC Core"); // default title
