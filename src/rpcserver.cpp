...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* WAC features */
        {"wac", "masternode", &masternode, true, true, false},
        {"wac", "listmasternodes", &listmasternodes, true, true, false},
        {"wac", "getmasternodecount", &getmasternodecount, true, true, false},
        {"wac", "masternodeconnect", &masternodeconnect, true, true, false},
        {"wac", "masternodecurrent", &masternodecurrent, true, true, false},
        {"wac", "masternodedebug", &masternodedebug, true, true, false},
        {"wac", "startmasternode", &startmasternode, true, true, false},
        {"wac", "createmasternodekey", &createmasternodekey, true, true, false},
        {"wac", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"wac", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"wac", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"wac", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"wac", "getmasternodescores", &getmasternodescores, true, true, false},
        {"wac", "mnbudget", &mnbudget, true, true, false},
        {"wac", "preparebudget", &preparebudget, true, true, false},
        {"wac", "submitbudget", &submitbudget, true, true, false},
        {"wac", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"wac", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"wac", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"wac", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"wac", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"wac", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"wac", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"wac", "checkbudgets", &checkbudgets, true, true, false},
        {"wac", "mnsync", &mnsync, true, true, false},
        {"wac", "spork", &spork, true, true, false},
        {"wac", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"wac", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use wacd, or the -server option to wac-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> wac-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:29282/\n";
}
