...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (300, uint256("b8f957c6418874824783fe20f7022cc59efbc328bdad2df017ef9635b96bdb9c"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1565985280, // * UNIX timestamp of last checkpoint block
    460,          // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 29281;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // WAC starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // WAC: 1 day
        nTargetSpacing = 1 * 60;  // WAC: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 120;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = " Warrantychain.info ";
        ...
        strSporkKey = "042719A12754FA7BB70787D4CA638860B7F6AB0FB7BDA825748C5C7134F4B2FCFBD8352098BB3D5B233FB3F95C2772C98E1FCD4728A550E498BD40446CBF51631C";
        strObfuscationPoolDummyAddress = "Wo3fnibtjwvqYE1T7Lce5uYbdt3pf6PKUu";
...
public:
    CTestNetParams()
    {
        ...
        // Testnet wac BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet wac BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet wac BIP44 coin type is '1' (All coin's testnet default)
