...
RESOURCES += src/qt/wac.qrc src/qt/wac_locale.qrc

TRANSLATIONS += src/qt/locale/wac_bg.ts \
                src/qt/locale/wac_de.ts \
                src/qt/locale/wac_en.ts \
                src/qt/locale/wac_es.ts \
                src/qt/locale/wac_fi.ts \
                src/qt/locale/wac_fr.ts \
                src/qt/locale/wac_it.ts \
                src/qt/locale/wac_ja.ts \
                src/qt/locale/wac_pl.ts \
                src/qt/locale/wac_pt.ts \
                src/qt/locale/wac_ru.ts \
                src/qt/locale/wac_sk.ts \
                src/qt/locale/wac_sv.ts \
                src/qt/locale/wac_vi.ts \
                src/qt/locale/wac_zh_CN.ts \
                src/qt/locale/wac_zh_TW.ts
