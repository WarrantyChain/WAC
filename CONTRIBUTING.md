Contributing to WAC Core
============================

The WAC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the WAC Core project, and is not to be
confused with overall WAC Network Protocol consensus changes.

Whether a pull request is merged into WAC Core rests with the project merge
...
Patches that change WAC consensus rules are considerably more involved than
...
Where a patch set proposes to change the WAC consensus, it must have been
...
The project leader is the release manager for each WAC Core release.
