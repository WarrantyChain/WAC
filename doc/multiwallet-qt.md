...
In order to support loading of multiple wallets in wac-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is wac.cpp.
...
Changes to wac.cpp
----------------------
wac.cpp is the entry point into wac-qt, and as such, will require some minor modifications to provide hooks for
