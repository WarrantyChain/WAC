...
This mechanism has been integrated into Bitcore-Node-WAC which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/WAC-Project/insight-api-wac#web-socket-api](https://github.com/WAC-Project/insight-api-wac#web-socket-api) 
* API: [https://github.com/WAC-Project/insight-api-wac#swifttx-transactions](https://github.com/WAC-Project/insight-api-wac#swifttx-transactions) 
...
By default, the WAC Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the WAC Core daemon:
